...
# --- [설정] 툴팁 데이터 (지표 설명) ---
tooltip_data = {
    "Citi 매크로 리스크": {"desc": "시티은행이 시장의 위험 수준을 점수로 매긴 지표입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "KOSPI200 기대변동성(VKOSPI)": {"desc": "한국 주식 시장의 '공포 지수'입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "S&P500 기대변동성(VIX)": {"desc": "미국 주식 시장의 '공포 지수'입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 정책불확실성 지수": {"desc": "미국 정부 정책의 불확실성을 수치화한 지표입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "국내 CDS 프리미엄": {"desc": "한국 국채의 부도 위험에 대한 보험료입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "외환변동성지수(JPM)": {"desc": "환율의 등락 폭이 얼마나 심한지 보여줍니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "채권 기대변동성(MOVE)": {"desc": "미국 국채 금리의 변동성을 나타내는 '채권판 공포지수'입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "글로벌 금융 스트레스(BofA)": {"desc": "전 세계 금융 시장의 자금 경색 정도를 보여줍니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "신흥국채권 스프레드(JPM EMBI)": {"desc": "신흥국이 돈을 빌릴 때 미국보다 더 내야 하는 이자율 차이입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 하이일드 스프레드": {"desc": "신용도가 낮은 미국 기업의 채권 금리와 국채 금리의 차이입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "美주간경제인덱스(WEI)": {"desc": "미국 실물 경제의 활동성을 매주 측정하는 지표입니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "글로벌경기선행지수": {"desc": "향후 3~6개월 뒤의 세계 경기 흐름을 예측하는 지표입니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "국내 경기선행지수 순환변동치": {"desc": "한국 경기의 상승/하강 국면을 미리 보여주는 지표입니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "미국 ISM제조업지수": {"desc": "미국 제조업 경기를 나타내는 설문 지표입니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "미국 경기서프라이즈 지수": {"desc": "실제 경제 지표가 예상치보다 얼마나 좋았는지 보여줍니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "국내 수출증가율": {"desc": "작년 대비 수출액이 얼마나 늘었는지 보여줍니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "건화물 운임지수(BDI)": {"desc": "원자재를 나르는 배의 운임료로, 세계 무역 활성도를 보여줍니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "글로벌주식모멘텀": {"desc": "전 세계 주식 시장의 상승 추세 강도입니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "외국인 순매수(60일 누계)": {"desc": "최근 2달간 외국인이 국내 주식을 얼마나 샀는지(팔았는지) 보여줍니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "국고채 장단기금리차(10Y-3Y)": {"desc": "장기 금리와 단기 금리의 차이입니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "미 장단기금리차(10년-2년)": {"desc": "미국 장기 금리와 단기 금리의 차이입니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "원달러 환율": {"desc": "1달러를 사기 위해 필요한 원화 금액입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "달러인덱스(DXY)": {"desc": "주요 6개국 통화 대비 달러화의 가치를 보여줍니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국채 10년물 금리": {"desc": "글로벌 장기 금리의 기준이 되는 지표입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "국내 기준금리": {"desc": "한국은행이 결정하는 정책 금리입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 기대인플레이션(5년)": {"desc": "시장 참여자들이 예상하는 향후 5년 평균 물가 상승률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "유가(WTI 최근월물)": {"desc": "국제 원유 가격(서부 텍사스산 중질유)입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 부동산담보대출 연체율": {"desc": "미국 상업은행의 부동산 대출 연체 비율입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 모기지 금리(30년)": {"desc": "미국 주택 담보 대출의 대표 금리입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 주택가격 지수": {"desc": "미국 주택 가격의 변동을 나타내는 지수입니다.", "interpretation": "수치가 낮을수록, 리스크지수를 높게 환산했습니다."},
    "미국 상업용 부동산 공실률": {"desc": "미국 상업용 건물(오피스 등)이 비어있는 비율입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 상업용 부동산 공실률 (LA)": {"desc": "LA 지역 상업용 부동산 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 상업용 부동산 공실률 (보스턴)": {"desc": "보스턴 지역 상업용 부동산 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 상업용 부동산 공실률 (시카고)": {"desc": "시카고 지역 상업용 부동산 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "미국 상업용 부동산 공실률 (애틀랜타)": {"desc": "애틀랜타 지역 상업용 부동산 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "오피스 공실률 (뉴욕)": {"desc": "뉴욕 오피스 빌딩의 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "오피스 공실률 (샌프란시스코)": {"desc": "샌프란시스코 오피스 빌딩의 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "오피스 공실률 (파리)": {"desc": "파리 오피스 빌딩의 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "오피스 공실률 (런던)": {"desc": "런던 오피스 빌딩의 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "오피스 공실률 (베를린)": {"desc": "베를린 오피스 빌딩의 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "오피스 공실률 (마드리드)": {"desc": "마드리드 오피스 빌딩의 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},
    "오피스 공실률 (멜버른)": {"desc": "멜버른 오피스 빌딩의 공실률입니다.", "interpretation": "수치가 높을수록, 리스크지수를 높게 환산했습니다."},

    "국내 리스크종합지수": {"desc": "세부 리스크 지표들의 산술평균입니다.", "interpretation": "수치가 높을수록, 종합적 국내 리스크가 높습니다."},
    "글로벌 리스크종합지수": {"desc": "세부 리스크 지표들의 산술평균입니다.", "interpretation": "수치가 높을수록, 종합적 글로벌 리스크가 높습니다."},
    "국내주식리스크": {"desc": "세부 리스크 지표들의 산술평균입니다.", "interpretation": "수치가 높을수록, 국내 주식 리스크가 높습니다."},
    "글로벌주식리스크": {"desc": "세부 리스크 지표들의 산술평균입니다.", "interpretation": "수치가 높을수록, 글로벌 주식 리스크가 높습니다."},
    "채권리스크": {"desc": "세부 리스크 지표들의 산술평균입니다.", "interpretation": "수치가 높을수록, 채권 리스크가 높습니다."},
    "외환리스크": {"desc": "세부 리스크 지표들의 산술평균입니다.", "interpretation": "수치가 높을수록, 외환 리스크가 높습니다."},
    "크레딧/유동성리스크": {"desc": "세부 리스크 지표들의 산술평균입니다.", "interpretation": "수치가 높을수록, 크레딧/유동성 리스크가 높습니다."}
    ...
    def RISK_SECTION(name, indicators, categories):
        ...
        with st.container(border=True):
            ...
            if is_alt:
                ...
                if target_desc:
                    desc_placeholder.info(f"**{target_col}**: {target_desc} {target_interpret}", icon="💡")
